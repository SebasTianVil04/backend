...
class Examen(AuditoriaMixin, Base):
...
class PreguntaExamen(AuditoriaMixin, Base):
...
class ResultadoExamen(AuditoriaMixin, Base):
    ...
    usuario = relationship("Usuario", back_populates="resultados_examenes", foreign_keys=[usuario_id])
